...
public class AL10 {
    ...
    public static void alSource(int source, int paramName, FloatBuffer values) {
        alSourcefv(source, paramName, values);
    }

    public static void alSource(int source, int paramName, IntBuffer values) {
        long __functionAddress = AL.getICD().alSourceiv;
        invokePV(source, paramName, memAddress(values), __functionAddress);
    }
