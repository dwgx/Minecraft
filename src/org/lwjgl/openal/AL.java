...
public final class AL {
    ...
    public static synchronized void create() throws LWJGLException {
        ...
        if (device == 0L) {
            throw new LWJGLException("Failed to open default OpenAL device");
        }
        ...
        if (context == 0L) {
            ...
            device = 0L;
            throw new LWJGLException("Failed to create OpenAL context");
        }

        try {
            ALC10.alcMakeContextCurrent(context);
            ALCCapabilities alcCaps = ALC.createCapabilities(device);
            ALCapabilities alCaps = createCapabilities(alcCaps);
            setCurrentProcess(alCaps);
            ...
            throw new LWJGLException("Failed to initialize OpenAL capabilities", t);
        }
    }
